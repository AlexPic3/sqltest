...
CREATE TABLE DiaSemanaCurso (
	IdDiaSemanaCurso int IDENTITY (1,1),
	-- Constraint 3
	FkDiaSemana int,
...
CREATE TABLE ReservaSocio (
	IdReservaSocio int IDENTITY (1,1),
	-- Constraint 6
	FkReserva int,
...
VALUES('12345678A', 'FED1234567890', 'Juan', 'P�rez', 'Garc�a', 'Calle Falsa 123', '600123456'),
		('23456789B', 'FED1234567891', 'Ana', 'Mart�nez', 'L�pez', 'Avenida Siempre Viva 456', '600123457'),
		('34567890C', 'FED1234567892', 'Luis', 'Gonz�lez', 'Hern�ndez', 'Boulevard Central 789', '600123458'),
		('45678901D', 'FED1234567893', 'Mar�a', 'Rodr�guez', 'Fern�ndez', 'Pasaje del Sol 101', NULL),
		('56789012E', 'FED1234567894', 'Carlos', 'S�nchez', 'Ruiz', 'Calle Luna 202', '600123460'),
		('67890123F', 'FED1234567895', 'Laura', 'Ram�rez', 'Torres', 'Avenida del Mar 303', '600123461'),
		('78901234G', 'FED1234567896', 'Pedro', 'Flores', 'Jim�nez', 'Calle Olmo 404', '600123462'),
		('89012345H', 'FED1234567897', 'Elena', 'Guti�rrez', 'Moreno', 'Camino Real 505', NULL),
		('90123456I', 'FED1234567898', 'Jorge', 'D�az', 'Navarro', 'Avenida de los Pinos 606', '600123464'),
		('01234567J', 'FED1234567899', 'Sof�a', 'Fern�ndez', 'Molina', 'Calle del R�o 707', '600123465'),
		('12345678K', 'FED1234567900', 'Andr�s', 'L�pez', 'Ortiz', 'Paseo de las Flores 808', '600123466'),
		('23456789L', 'FED1234567901', 'Luc�a', 'Ruiz', 'Castro', 'Calle del Sol 909', NULL),
		('34567890M', 'FED1234567902', 'Ricardo', 'Hern�ndez', 'Vega', 'Avenida de la Luz 100', '600123468'),
...
INSERT INTO DiaSemanaCurso (FkDiaSemana, FkCurso)
	VALUES (1, 'C001'),  -- Lunes
		(2, 'C002'),  -- Martes
		(3, 'C003'),  -- Mi�rcoles
		(4, 'C004'),  -- Jueves
